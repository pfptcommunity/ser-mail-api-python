...
if __name__ == "__main__":
    ...
    message = (
        ...
        .add_content("<b>This is a test message</b><br><img src=\"cid:logo_a\">", ContentType.Html)
        ...
        .add_to("recipient2@example.com", "Recipient 2")
        .add_cc("cc1@example.com", "CC Recipient 1")
        .add_cc("cc2@example.com", "CC Recipient 2")
        .add_bcc("bcc1@example.com", "BCC Recipient 1")
        .add_bcc("bcc2@example.com", "BCC Recipient 2")
        .add_attachment(Attachment.Builder()
        ...
        .add_attachment(Attachment.Builder()
                        ...
                        .build())
        .add_reply_to("noreply@proofpoint.com", "No Reply").build()
    )
    #
